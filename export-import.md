---
description: 新在手在寫js，常常會看到各式各樣的輸出引入的方式，本篇就是來整理一下import export require之間的來龍去脈。
---

# JS輸入輸出

#### export import <a href="#export-import" id="export-import"></a>
...
## 模組系統 <a href="#mo-zu-xi-tong" id="mo-zu-xi-tong"></a>
